...
import "./App.scss";
import "./components/Menu-collapsable.scss";
...
function App() {
    return (
        <div className="App">
            ...
            <MenuCollapsable></MenuCollapsable>
            <MenuCollapsable startValue={true}></MenuCollapsable>
            <MenuCollapsable startValue={false}></MenuCollapsable>
        </div>
    );
}
